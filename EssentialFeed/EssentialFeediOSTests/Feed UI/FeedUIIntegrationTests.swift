...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageView_loadsImageURLWhenVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [], "Expect no image request until views become visible")
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [], "Expect no cancelled image request until image is not visible")
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        let invalidImageData = Data("Invalid image data".utf8)
         ...
         XCTAssertEqual(view?.isShowingRetryAction, true, "Expected retry action image load completes with invalid image data")
     }
    ...
    func test_feedImageView_preloadsImageURLWhenNearVisible() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [image0, image1], at: 0)
        XCTAssertEqual(loader.loadedImageURLs, [], "Expect no image request until image is near visible")
