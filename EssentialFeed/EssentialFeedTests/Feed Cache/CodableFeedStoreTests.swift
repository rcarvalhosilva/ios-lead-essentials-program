...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_inset_deliversErrorOnInsertionFailure() {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationInOrder, [op1, op2, op3], "Expected side-effect operations to run serially but operations finished in the wrong order")
    }
    ...
    private func makeSUT(
        ...
        let feedStore = CodableFeedStore(storeURL: storeURL ?? testSpecificStoreURL())
